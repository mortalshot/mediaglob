    ...
    function initSliders() {
        if (document.querySelector(".home-template__slider")) {
            ...
            function homeSlider6mdChange(e) {
                if (e.matches) homeSlider = new core(".home-template__slider", {
                ...
                }); else if (homeSlider) homeSlider.destroy();
            }
            homeSlider6md.addEventListener("change", homeSlider6mdChange);
            homeSlider6mdChange(homeSlider6md);
        }
        if (document.querySelector(".template4__slider")) new core(".template4__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
...
***************************************************************************** */
    ...
    function galleryAnimation() {
        let zSpacing = -1e3, lastPoss = zSpacing / 5, $frames = document.getElementsByClassName("gallery-frame"), frames = Array.from($frames), zVals = [];
        ...
        window.onscroll = function() {
            let top = document.documentElement.scrollTop, delta = lastPoss - top;
            lastPoss = top;
